  ...
  return (
    <div className="py-6">
      <div className="max-w-5xl mx-auto px-5 sm:px-6">
        <h1 className="text-2xl font-semibold my-5">SEO & a11y Services</h1>
        ...
        <p>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iste nulla, dolores aut atque
          aliquid suscipit distinctio maiores minus ut harum numquam dolore ad deleniti, rem vitae
          molestias quam quia praesentium beatae? Iusto repudiandae at accusantium, praesentium
          debitis mollitia et odit.
        </p>
